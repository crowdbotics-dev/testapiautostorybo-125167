...
## Project Structure
    ...
    ├── testapiautostorybo_125167  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_125167`
...
2. Clone this repo and `cd testapiautostorybo_125167`
